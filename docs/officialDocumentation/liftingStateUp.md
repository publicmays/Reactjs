...
* Ex. enter 37 into the Celsius input, the state of the Calculator component will be:
...
* The handleChange method in the TemperatureInput component calls `this.props`.
* `onTemperatureChange()` with the new desired value. 
